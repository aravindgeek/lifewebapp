            ...
            <form class="pure-form pure-form-aligned" action="/newuser" method="post">
                <fieldset>
                    <div class="pure-control-group">
                        ...
                        <input type="text" name="name" placeholder="Enter your actual name"/>
                    </div>
                    <div class="pure-control-group">
                        <label for="userid"> User Name : </label>
                        <input type="text" name="userid" placeholder="This is used to login"/>
                    </div>
                    <div class="pure-control-group">
                    ...
                    <div class="pure-control-group">
                        ...
                        <input type="text" name="email_2" placeholder="Retype your Email address"/>
                    </div>
                    <div class="pure-control-group">
                        <label for="passwd">Password:</label> 
                        <input type="password" name="passwd" placeholder="Min of 6 char with atleast one uppercase and digit"/>
                    </div>
                    <div class="pure-control-group">
                        <label for="passwd_2">Re-type:</label> 
                        <input type="password" name="passwd_2" placeholder="Retype the password" />
                    </div>
